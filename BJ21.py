...
def label_place_Bet():
    ...
    label_placeBet.place(x = 65,y = 325)
...
def main():
    ...
    button_bet100 = tkinter.Button(frame, text = "Bet 100", font=("Fixedsys", 16), command = lambda : bet_100(),
                                   bg = "blue", fg = "white", cursor = "hand2")
    global button_bet500
    button_bet500 = tkinter.Button(frame, text = "Bet 500", font=("Fixedsys", 16), command = lambda : bet_500(),
                                   bg = "green", fg = "white", cursor = "hand2")
    global button_bet1000
    button_bet1000 = tkinter.Button(frame, text = "Bet 1000", font=("Fixedsys", 16), command = lambda : bet_1000(),
